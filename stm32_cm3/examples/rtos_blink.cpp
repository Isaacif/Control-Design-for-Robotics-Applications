...
USART_peripheral serial_interface(GPIO9, GPIO10, GPIOA, 
...
extern "C" void ledBlinkTask(void *pvParameters) 
{
    ...
    while (1) {
        ...
        serial_interface.usartSend_integer(circularBufferGetRelativeElement(&e, -1));
...
int main(void) {
    ...
    xTaskCreate(ledBlinkTask, "Blink", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
